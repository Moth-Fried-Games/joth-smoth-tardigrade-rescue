...
func _ready() -> void:
	weapon_animation_player.animation_finished.connect(_on_weapon_animation_player_animation_finished)
	petting_animation_player.animation_finished.connect(_on_petting_animation_player_animation_finished)
